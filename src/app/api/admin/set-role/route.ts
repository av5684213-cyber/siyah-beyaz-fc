...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // The email allowlist protects against unauthorized emails; this adds identity verification
    ...
    // If no x-admin-user-id header, fall back to email-allowlist-only protection
    // (for automated scripts that don't have a user context)
