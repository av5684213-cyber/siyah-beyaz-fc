      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && filteredEntries.length === 0 && (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-slate-300 mb-2">Henüz efsane yok</h2>
            <p className="text-slate-500">Sezonlar tamamlandıkça efsaneler buraya eklenecek.</p>
          </div>
        )}
