...
const ACADEMY_LEVEL_CONFIG = {
  ...
  6: {
    ratingRange: [55, 70] as [number, number],
    potentialRange: [75, 90] as [number, number],
    wonderkidChance: 0.08,
    avgStatLevel: 62,
    positionDistribution: { GK: 0.05, DEF: 0.30, MID: 0.40, FWD: 0.25 },
  },
  7: {
    ratingRange: [58, 73] as [number, number],
    potentialRange: [78, 92] as [number, number],
    wonderkidChance: 0.10,
    avgStatLevel: 66,
    positionDistribution: { GK: 0.05, DEF: 0.30, MID: 0.40, FWD: 0.25 },
  },
  8: {
    ratingRange: [60, 75] as [number, number],
    potentialRange: [80, 94] as [number, number],
    wonderkidChance: 0.12,
    avgStatLevel: 70,
    positionDistribution: { GK: 0.05, DEF: 0.28, MID: 0.40, FWD: 0.27 },
  },
  9: {
    ratingRange: [62, 77] as [number, number],
    potentialRange: [82, 96] as [number, number],
    wonderkidChance: 0.15,
    avgStatLevel: 74,
    positionDistribution: { GK: 0.05, DEF: 0.28, MID: 0.40, FWD: 0.27 },
  },
  10: {
    ratingRange: [65, 80] as [number, number],
    potentialRange: [85, 98] as [number, number],
