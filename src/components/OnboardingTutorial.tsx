...
const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      'Her şey hazır mı? Taktiklerini belirle, ilk 11\'i seç ve sahaya çık! Maç simülasyonu canlı olarak oynanır, taktik değişikliklerin skorun kaderini belirler.',
  ...
  },
  {
    ...
    title: 'Ligde Yüksel',
    description:
      'Süper Lig\'e çıkmak için her maç önemli! Fikstürü takip et, antrenmanlarla oyuncularını geliştir ve sezon sonunda şampiyonluk kupasını kaldır.',
