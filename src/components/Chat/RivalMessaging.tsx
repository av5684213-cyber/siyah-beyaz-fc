                  ...
                  <motion.div key="chat" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="p-2.5 bg-zinc-900/50 border-t border-white/5 shrink-0">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button onClick={handleSend} disabled={!inputText.trim() || isSending} className="shrink-0 w-9 h-9 bg-team-primary hover:bg-team-primary-hover disabled:bg-white/5 disabled:text-white/10 rounded-xl flex items-center justify-center transition-all active:scale-95">
