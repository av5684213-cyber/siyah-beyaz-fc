...
const HINTS_POOL: Hint[] = [
  ...
  { id: 'hint-scout', category: 'Keşif', text: 'Scout raporu almak 150K krediye mal olur, ancak gizli yetenekleri ortaya çıkarabilir. Yatırıma değer!' },
  { id: 'hint-training', category: 'Antrenman', text: 'Genç oyuncular (22 yaş altı) antrenmandan daha çok gelişir. Onlara şans ver!' },
  { id: 'hint-tactics', category: 'Taktik', text: 'Mentality ayarın maç sonucunu etkiler. Offensive daha çok gol ama daha çok yersin!' },
  { id: 'hint-stamina', category: 'Form', text: 'Form ratingi düşük oyuncular maçta daha az katkı sağlar. Antrenmanla formu yükselt!' },
  { id: 'hint-sell-tax', category: 'Finans', text: 'Oyuncu sattığında %2.5 vergi kesilir. Fiyatı iyi hesapla!' },
  ...
  { id: 'hint-pressing', category: 'Taktik', text: 'High pressing topu daha çabuk kazandır ama staminaları hızla düşer. İkinci yarıda yorulursun!' },
  ...
  { id: 'hint-matchday', category: 'Maç Günü', text: 'Maç günü sekmesinden hazırlık maçı yapabilirsin. Denemekten çekinme!' },
  ...
  { id: 'hint-cup', category: 'Kupa', text: 'Kupa maçları ligden farklıdır. Eleme usulü olduğu için her maç final gibidir!' },
  ...
  { id: 'hint-wages', category: 'Finans', text: 'Her hafta oyuncu maaşları otomatik ödenir. Bütçeni iyi yönet, iflasa düşme!' },
  { id: 'hint-sponsor', category: 'Finans', text: 'Sponsor anlaşmaları düzenli gelir sağlar. Taraftar sayısı arttıkça daha iyi sponsor gelir!' },
];
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-16 right-4 z-40 max-w-[320px]"
        >
