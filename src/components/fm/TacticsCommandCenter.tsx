  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
        ...
        <div className="md:col-span-8 lg:col-span-5 xl:col-span-5 relative aspect-[2/3] xl:aspect-auto bg-[#1a472a] border-4 border-white/20 rounded-[2.5rem] overflow-hidden shadow-2xl min-h-[400px] md:min-h-[600px]">
