  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            ...
            <div className="p-4 bg-zinc-900 border-t border-white/5">
              ...
              <div className="flex gap-2">
                ...
                <button 
                  onClick={handleSend}
                  className="w-10 h-10 bg-team-primary rounded-lg flex items-center justify-center hover:bg-team-primary-hover active:scale-95 transition-all"
                >
                  <Send size={16} />
                </button>
              </div>
      ...
      <button
        ...
        className="w-14 h-14 bg-team-primary rounded-full shadow-2xl flex items-center justify-center group hover:scale-110 transition-all relative overflow-hidden"
      >
