...
export function AppHeader({ 
  ...
  return (
    <header className="border-b border-white/5 p-2 sm:p-4 lg:p-6 flex justify-between items-center sticky top-0 bg-black/60 backdrop-blur-2xl z-50 gap-2">
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-5 min-w-0 flex-1">
        <div className="relative shrink-0">
          <div 
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shadow-lg transition-transform hover:scale-105 overflow-hidden"
        ...
        <div className="min-w-0">
          <h1 className="text-base sm:text-2xl font-black italic tracking-tighter leading-none flex items-baseline gap-1.5 sm:gap-2 text-white min-w-0">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 mt-1 sm:mt-1.5 text-[8px] sm:text-[9px] uppercase font-bold tracking-[0.15em] sm:tracking-[0.2em] text-white/40 flex-wrap">
            <span className="flex items-center gap-1 font-black">
              <Activity size={9} className="sm:hidden" style={{ color: profile?.secondary_color || '#ef4444' }} />
              <Activity size={10} className="hidden sm:block" style={{ color: profile?.secondary_color || '#ef4444' }} />
              <span className="truncate max-w-[80px] sm:max-w-none">{profile?.league_name?.toUpperCase() || t('header_super_lig')}</span>
            </span>
      ...
      <div className="flex items-center gap-2 sm:gap-3 lg:gap-6 shrink-0">
        ...
        <div className="text-right flex flex-col items-end border-l border-white/5 pl-2 sm:pl-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2 justify-end">
            ...
            <p className="font-mono text-sm sm:text-lg font-medium tracking-tighter text-emerald-400">
        ...
        <div className="text-right flex flex-col items-end border-l border-white/5 pl-2 sm:pl-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 justify-end">
            ...
            <p className="font-mono text-sm sm:text-lg font-medium tracking-tighter text-amber-400">
