  ...
  return (
    ...
    >
      ...
      >
        ...
        ══════════════════════════════════════════════ */}
        <div className="flex items-center gap-0 px-2 md:px-4 bg-[#0d1218] border-b border-white/[0.06] overflow-x-auto scrollbar-none flex-nowrap">
          {tabs.map(tab => (
            <button
              key={tab.id}
