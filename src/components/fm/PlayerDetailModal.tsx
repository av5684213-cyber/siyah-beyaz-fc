  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeTab === 'antrenman' && (
          <div className="p-3 sm:p-4 md:p-8 space-y-4 sm:space-y-6">
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center border border-emerald-500/20">
                <Dumbbell className="text-emerald-400" size={20} />
              </div>
              <div>
                <h3 className="text-base sm:text-xl font-black italic uppercase tracking-tighter">Bireysel Gelişim</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
              ...
              {/* Status Info */}
              <div className="p-3 sm:p-6 bg-emerald-950/20 border border-emerald-500/10 rounded-xl sm:rounded-[2rem] space-y-4">
        ...
        ══════════════════════════════════════════════ */}
        {activeTab === 'market' && (
          <div className="p-3 sm:p-4 md:p-10 space-y-6 sm:space-y-8">
            {/* TRANSFER OFFER HANDLING */}
            {player.transferOffer && (
              <div className="max-w-xl mx-auto mb-4 sm:mb-10 p-3 sm:p-8 bg-amber-500/10 border border-amber-500/30 rounded-2xl sm:rounded-[3rem] animate-pulse">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-amber-500 rounded-xl sm:rounded-[1.5rem] flex items-center justify-center shadow-lg">
                    <ShoppingCart size={24} className="text-black" />
                  </div>
                  <div>
                    <h3 className="text-lg sm:text-2xl font-black italic uppercase tracking-tighter text-white">Gelen Transfer Teklifi!</h3>
                ...
                <div className="bg-black/40 p-3 sm:p-6 rounded-2xl border border-white/5 mb-4 sm:mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <button 
                    ...
                    className="flex-1 bg-emerald-500 text-black py-4 sm:py-5 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:scale-[1.02] transition-all shadow-xl"
                  >
                    Kabul Et
                  </button>
                  <button 
                    ...
                    className="flex-1 bg-red-500/20 text-red-500 border border-red-500/30 py-4 sm:py-5 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-red-500 hover:text-white transition-all"
                  >
                    Reddet
                  </button>
                </div>
            ...
            {onSign ? (
              <div className="max-w-xl mx-auto space-y-5 sm:space-y-8 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="mx-auto w-16 h-16 sm:w-24 sm:h-24 bg-emerald-500/10 rounded-2xl sm:rounded-[2rem] flex items-center justify-center border border-emerald-500/20 rotate-12 mb-4 sm:mb-6">
                   <Footprints className="text-emerald-500" size={32} />
                </div>
                <h3 className="text-2xl sm:text-4xl font-black italic uppercase tracking-tighter">Sözleşme Görüşmesi</h3>
                <p className="text-xs font-bold text-white/30 uppercase tracking-[0.4em]">Yeni Yetenek İmzala</p>

                <div className="bg-white/5 p-4 sm:p-8 rounded-2xl sm:rounded-[3rem] border border-white/5">
                   <div className="text-[10px] font-black uppercase tracking-widest text-white/20 mb-2">Talep Edilen İmza Parası</div>
                   <div className="text-2xl sm:text-4xl font-black font-mono tracking-tighter italic text-emerald-400">
                ...
                <button 
                  ...
                  className="w-full bg-emerald-500 text-black py-4 sm:py-6 rounded-2xl sm:rounded-[2rem] text-[12px] font-black uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-2xl flex items-center justify-center gap-3"
                >
              ...
              /* BUYING CONTEXT */
              <div className="max-w-xl mx-auto space-y-5 sm:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center space-y-3 sm:space-y-4">
                  <div className={`mx-auto w-16 h-16 sm:w-24 sm:h-24 rounded-2xl sm:rounded-[2rem] flex items-center justify-center border rotate-12 mb-4 sm:mb-6 ${marketListing.is_auction ? 'bg-amber-500/10 border-amber-500/20' : 'bg-emerald-500/10 border-emerald-500/20'}`}>
                    {marketListing.is_auction ? <Gavel className="text-amber-500" size={32} /> : <ShoppingCart className="text-emerald-500" size={32} />}
                  </div>
                ...
                {marketListing.is_auction ? (
                  ...
                  <>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                      <div className="bg-amber-500/10 p-4 sm:p-5 rounded-2xl sm:rounded-[2rem] border border-amber-500/20 flex flex-col items-center gap-2">
                      ...
                      <div className="bg-white/5 p-4 sm:p-5 rounded-2xl sm:rounded-[2rem] border border-white/5 flex flex-col items-center gap-2">
                    ...
                    {/* Action buttons */}
                    <div className="flex gap-3 sm:gap-4 sticky bottom-0 sm:static bg-black/80 sm:bg-transparent backdrop-blur-md sm:backdrop-blur-none -mx-3 sm:mx-0 px-3 sm:px-0 py-3 sm:py-0 border-t border-white/10 sm:border-0">
                      {!isSeller && !isHighestBidder && (
                        <button
                          ...
                          className="flex-[2] bg-amber-500 text-black py-4 sm:py-6 rounded-2xl sm:rounded-[2rem] text-[12px] font-black uppercase tracking-[0.2em] hover:bg-amber-400 disabled:opacity-20 disabled:grayscale transition-all shadow-[0_20px_50px_rgba(245,158,11,0.2)] flex items-center justify-center gap-3"
                        >
                          {isBuying ? <Activity className="animate-spin" size={18} /> : 'TEKLİF VER'}
                        </button>
                      )}
                      {!isSeller && isHighestBidder && (
                        <div className="flex-[2] bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 py-4 sm:py-6 rounded-2xl sm:rounded-[2rem] text-[12px] font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3">
                      ...
                      {isSeller && (
                        <button
                          ...
                          disabled={isBuying}
                          className="flex-[2] bg-red-500/20 border border-red-500/30 text-red-400 py-4 sm:py-6 rounded-2xl sm:rounded-[2rem] text-[12px] font-black uppercase tracking-[0.2em] hover:bg-red-500 hover:text-white disabled:opacity-20 disabled:grayscale transition-all flex items-center justify-center gap-3"
                        >
                  ...
                  <>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      <div className="bg-white/5 p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-white/5 group hover:border-white/10 transition-all">
                        <div className="text-[10px] font-black uppercase tracking-widest text-white/20 mb-2">Satış Fiyatı</div>
                        <div className="text-2xl sm:text-3xl font-black font-mono tracking-tighter italic text-white/90">{formatCurrency(marketListing.price)}</div>
                      ...
                      <div className="bg-amber-500/10 p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-amber-500/20 group hover:border-amber-500/30 transition-all">
                        <div className="text-[10px] font-black uppercase tracking-widest text-amber-500/40 mb-2">Maksimum Limit</div>
                        <div className="text-2xl sm:text-3xl font-black font-mono tracking-tighter italic text-amber-400">{formatCurrency(marketListing.max_price || marketListing.price * 1.5)}</div>
                    ...
                    <div className="flex gap-3 sm:gap-4 sticky bottom-0 sm:static bg-black/90 sm:bg-transparent backdrop-blur-md sm:backdrop-blur-none -mx-3 sm:mx-0 px-3 sm:px-0 py-3 sm:py-0 border-t border-white/10 sm:border-0">
                      <button
                        onClick={async () => {
                          setIsBuying(true);
                          try {
                        ...
                        className="flex-[2] bg-emerald-500 text-black py-4 sm:py-6 rounded-2xl sm:rounded-[2rem] text-[12px] font-black uppercase tracking-[0.2em] hover:bg-emerald-400 disabled:opacity-20 disabled:grayscale transition-all shadow-[0_20px_50px_rgba(16,185,129,0.2)] flex items-center justify-center gap-3 w-full"
                      >
