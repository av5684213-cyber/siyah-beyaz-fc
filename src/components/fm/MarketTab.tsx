...
const PlayerRowComponent = React.memo(function PlayerRowComponent({ index, style, ariaAttributes, rows, onNegotiate, columnCount }: {
        ...
        <div className="space-y-6">
          ...
          {marketLoading ? (
              ...
              <List<PlayerRowData>
                ...
                rowHeight={240}
                rowProps={{ rows: playerRows, onNegotiate: handleOpenNegotiation, columnCount }}
                overscanCount={5}
