...
"[project]/src/app/api/facilities/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (!profileId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: true,
                message: 'profileId gerekli.'
            }, {
                status: 400
            });
        }
        // Fetch user facilities
        const { data: facilities, error: facilitiesError } = await supabase.from('user_facilities').select('*').eq('profile_id', profileId);
        if (facilitiesError) {
            console.error('[GET /api/facilities] Error:', facilitiesError.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: true,
                message: 'Tesisler yüklenirken hata oluştu.'
            }, {
                status: 500
            });
        }
        ...
        let upgradeCosts = [];
        try {
            const { data: costs, error: costsError } = await supabase.from('facility_upgrade_costs').select('*').order('facility_type', {
                ascending: true
            }).order('target_level', {
                ascending: true
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff4bdc67._.js.map