...
"[project]/src/app/api/league/fixtures/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        if (leagueId && !isNaN(Number(leagueId))) {
            const { data: leagueData } = await supabase.from('leagues').select('id').eq('tier', parseInt(leagueId)).single();
        ...
        const { data: seasonData } = await supabase.from('seasons').select('id').eq('league_id', targetLeagueId).order('created_at', {
            ascending: false
        }).limit(1).single();
        if (!seasonData) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
      ...
      `).eq('season_id', seasonData.id).order('tur', {
            ascending: false
        }).order('match_date', {
            ascending: false
        }).limit(50);
        ...
        const cleanedFixtures = (fixtures || []).map((f)=>{
            ...
            return {
                ...
                home: {
                    name: homeName,
                    id: f.home?.id || f.home_team_id
                },
                away: {
                    name: awayName,
                    id: f.away?.id || f.away_team_id
                }
            };
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76a2d12e._.js.map