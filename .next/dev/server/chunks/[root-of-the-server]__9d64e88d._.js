...
"[project]/src/app/api/referees/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let refError = null;
        try {
            const result = await supabase.from('referees').select('*').eq('league_id', leagueId).order('name', {
                ascending: true
            });
        ...
        if (refError) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: true,
                message: 'Error loading referees.'
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9d64e88d._.js.map