...
"[project]/src/lib/fm/teamStats.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/tacticsEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/tacticsRoles.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/constants.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/trainingEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/constants.ts [app-client] (ecmascript)");
;
...
function isProgramCompatible(player, programId) {
    const program = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TRAINING_PROGRAMS"].find((p)=>p.id === programId);
...
const runTrainingSession = (squad, state, multiplier = 1.0, options)=>{
    ...
    const updatedSquad = squad.map((player)=>{
        ...
        const program = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TRAINING_PROGRAMS"].find((p)=>p.id === assignment.programId);
...
async function saveTrainingResults(results, updatedSquad, profileId, sessionType = 'morning', teamName = '') {
    ...
    let saved = 0;
    try {
        const { getSupabase } = await __turbopack_context__.A("[project]/src/lib/supabase.ts [app-client] (ecmascript, async loader)");
...
"[project]/src/lib/fm/ui-helpers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/positionWeights.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/positionEffectiveness.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionWeights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/positionWeights.ts [app-client] (ecmascript)");
;
...
function getPositionEffectiveness(player, targetPosition) {
    ...
    const weightProfile = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionWeights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["POSITION_WEIGHTS"][targetPosition];
...
function calculatePositionalTeamStrength(players) {
    ...
    for (const p of players){
        ...
        const contributions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionWeights$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionContributions"])(pos);
        // Moral/form/kondisyon modları
        const moraleMod = 0.85 + p.morale / 100 * 0.3;
        const formMod = 0.85 + p.form / 100 * 0.3;
        const condMod = 0.85 + p.cond / 100 * 0.3;
...
"[project]/src/lib/fm/referee.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/matchCommentaryGenerator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/stadiumMatrix.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/playStyles.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/enhancedMatchEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/positionEffectiveness.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/referee.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$matchCommentaryGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/matchCommentaryGenerator.ts [app-client] (ecmascript)");
...
function generateRichCommentary(type, player, secondaryPlayer, minute) {
    try {
        ...
        const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$matchCommentaryGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateCommentary"])(ctx);
        return result.text;
    } catch (err) {
...
function calculateTeamStrength(players, tactic) {
    ...
    const weightedRating = (group, ...attrs)=>{
        ...
        return group.reduce((sum, p)=>{
            ...
            const effectiveness = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionEffectiveness"])(p, p.specificPosition || p.position);
            ...
            const moraleMod = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_BASE"] + p.morale / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_VAR"];
            const formMod = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_BASE"] + p.form / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_VAR"];
            const condMod = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_BASE"] + p.cond / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_VAR"];
    ...
    let tacticMod = 1.0;
    // Mentality 1-5 scale
    if (tactic.mentality >= 4) tacticMod += (tactic.mentality - 3) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_MENTALITY_BONUS"];
    else if (tactic.mentality <= 2) tacticMod -= (3 - tactic.mentality) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_MENTALITY_PENALTY"];
    // Pressing bonus
    if (tactic.pressing) tacticMod += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_PRESSING_BONUS"];
    // Intensity
    if (tactic.intensity === 'high') tacticMod += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_HIGH_INTENSITY_BONUS"];
    else if (tactic.intensity === 'low') tacticMod -= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_LOW_INTENSITY_PENALTY"];
    // Aggression
    tacticMod += (tactic.aggression - __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_AGGRESSION_BASELINE"]) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TACTIC_AGGRESSION_SCALE"];
    // ── Formasyon bazlı ağırlık modifikatörleri ──────────────────────────
    const formationKey = tactic.formation || tactic.tactic_type || '4-4-2';
    const fmod = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORMATION_MODS"][formationKey] ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORMATION_MODS"]['4-4-2'];
    return {
        overall: (attack * fmod.attack * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_ATTACK"] + midfield * fmod.midfield * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_MIDFIELD"] + defense * fmod.defense * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_DEFENSE"] + gk * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_GK"]) * tacticMod,
...
function getWeatherModifiers(weather) {
    const mods = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WEATHER_MODIFIERS"][weather] ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WEATHER_MODIFIERS"]['sunny'];
    return {
        ...mods,
...
function getEventProbabilities(state, teamStrength, oppositionStrength, weatherMods, minute, isAttacking) {
    ...
    let chance = 0;
    let save = 0;
    const fatigueMod = state.currentCond < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_COND_THRESHOLDS"].low ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_COND_MODS"].low : state.currentCond < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_COND_THRESHOLDS"].mid ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_COND_MODS"].mid : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_COND_MODS"].full;
    const moraleMod = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_BASE"] + p.morale / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAT_MOD_VAR"];
    // Late game fatigue accumulation
    const fatigueMinute = minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_MINUTE_THRESHOLDS"].late ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_MINUTE_MODS"].late : minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_MINUTE_THRESHOLDS"].mid ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_MINUTE_MODS"].mid : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FATIGUE_MINUTE_MODS"].fresh;
    const effectiveMod = fatigueMod * moraleMod * fatigueMinute;
    // Pozisyon etkinlik puanı — spesifik mevkideki gerçek etkinlik
    const effectiveness = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionEffectiveness"])(p, specPos);
    if (isAttacking) {
        if (pos === 'FWD') {
            ...
            shot = clamp(getAttr(p, shotAttr) / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.shotMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.shotMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.shotMax);
            chance = clamp(getAttr(p, 'offTheBall') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.chanceMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.chanceMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.chanceMax);
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].FWD.foul;
        } else if (pos === 'MID') {
            ...
            if (isCDM) {
                shot = clamp(getAttr(p, 'longShots') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMultiplier * effectiveMod * effectiveness * 0.5, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMax * 0.6);
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 1.3, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMax * 1.3);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 1.2, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMax * 1.2);
                chance = clamp(getAttr(p, 'vision') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMultiplier * effectiveMod * effectiveness * 0.6, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMax * 0.7);
            } else if (isCAM) {
                shot = clamp(getAttr(p, 'longShots') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMultiplier * effectiveMod * effectiveness * 1.3, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMax * 1.3);
                chance = clamp(getAttr(p, 'vision') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMultiplier * effectiveMod * effectiveness * 1.4, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMax * 1.4);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 0.5, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMax * 0.6);
            } else if (isWinger) {
                shot = clamp(getAttr(p, 'crossing') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMultiplier * effectiveMod * effectiveness * 1.1, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMax * 1.1);
                chance = clamp(getAttr(p, 'dribbling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMultiplier * effectiveMod * effectiveness * 1.2, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMax * 1.2);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 0.7, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMax * 0.7);
            } else {
                // CM (standart)
                shot = clamp(getAttr(p, 'longShots') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.shotMax);
                chance = clamp(getAttr(p, 'vision') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMax);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.interceptionMax);
            }
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.foul;
        } else if (pos === 'DEF') {
            ...
            if (isFullback || isWingback) {
                ...
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMultiplier * effectiveMod * effectiveness * 0.8, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMax * 0.9);
                chance = clamp(getAttr(p, 'crossing') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMultiplier * effectiveMod * effectiveness * 0.4, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].MID.chanceMax * 0.4);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMultiplier * effectiveMod * effectiveness * 0.9, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMax * 0.9);
            } else {
                // CB (standart)
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.tackleMax);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.interceptionMax);
            }
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].DEF.foul;
        } else if (pos === 'GK') {
            save = clamp(getAttr(p, 'goalkeeping') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].GK.saveMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].GK.saveMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ATTACK_PROBS"].GK.saveMax);
        }
    } else {
        // Defending phase
        if (pos === 'DEF') {
            ...
            if (isFullback || isWingback) {
                ...
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMultiplier * effectiveMod * effectiveness * 0.9, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMax * 0.95);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMultiplier * effectiveMod * effectiveness * 0.8, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMax * 0.85);
            } else {
                // CB (standart)
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.tackleMax);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.interceptionMax);
            }
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].DEF.foul;
        } else if (pos === 'MID') {
            const isCDM = specPos === 'CDM';
            const isCAM = specPos === 'CAM';
            if (isCDM) {
                // CDM: savunma fazında çok etkili
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMultiplier * effectiveMod * effectiveness * 1.3, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMax * 1.3);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 1.3, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMax * 1.3);
            } else if (isCAM) {
                // CAM: savunma fazında az etkili
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMultiplier * effectiveMod * effectiveness * 0.5, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMax * 0.6);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness * 0.5, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMax * 0.6);
            } else {
                // CM (standart)
                tackle = clamp(getAttr(p, 'tackling') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.tackleMax);
                interception = clamp(getAttr(p, 'anticipation') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.interceptionMax);
            }
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].MID.foul;
        } else if (pos === 'GK') {
            save = clamp(getAttr(p, 'goalkeeping') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].GK.saveMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].GK.saveMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].GK.saveMax);
        } else if (pos === 'FWD') {
            interception = clamp(getAttr(p, 'aggression') / 100 * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].FWD.interceptionMultiplier * effectiveMod * effectiveness, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].FWD.interceptionMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].FWD.interceptionMax);
            foul = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFEND_PROBS"].FWD.foul;
        }
    }
    // Strength ratio modifier
    const strengthRatio = teamStrength / (teamStrength + oppositionStrength);
    if (isAttacking) {
        shot *= strengthRatio * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STRENGTH_RATIO"].attackShot;
        chance *= strengthRatio * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STRENGTH_RATIO"].attackChance;
    } else {
        tackle *= (1 - strengthRatio) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STRENGTH_RATIO"].defendTackle;
        save *= (1 - strengthRatio) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STRENGTH_RATIO"].defendSave;
    }
    // Weather modifiers
    ...
    return {
        shot: clamp(shot, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].shot),
        tackle: clamp(tackle, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].tackle),
        interception: clamp(interception, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].interception),
        foul: clamp(foul, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].foul),
        chance: clamp(chance, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].chance),
        save: clamp(save, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].save)
    };
}
// =============================================================================
...
function ensureTraitLookup() {
    ...
    for (const [category, data] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$traitsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TRAITS_DATA"])){
        const catData = data;
    ...
    if (defendingGK) {
        ...
        for (const traitName of traits){
            ...
            if (info.category === 'kaleci' || !info.isOffensive) {
                ...
                probs.save = clamp(probs.save, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].save);
            }
        }
    }
    ...
    if (defendingDefender) {
        ...
        for (const traitName of traits){
            ...
            if (!info.isOffensive) {
                ...
                probs.tackle = clamp(probs.tackle, 0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROB_CAPS"].tackle);
            }
        }
    }
}
function simulateEnhancedMatch(homePlayers, awayPlayers, homeTactic, awayTactic, options) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearEffectivenessCache"])();
    // ── Pre-match Setup ─────────────────────────────────────────────────────
    const weather = options?.weather ?? pick(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WEATHER_DISTRIBUTION"]);
    ...
    const createMutableState = (players, team)=>{
        return players.map((p)=>({
                ...
                ratingDelta: 0,
                minuteEntered: 0,
                minuteLeft: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].duration
            }));
    };
    ...
    const refCtx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRefereeMatchContext"])(defaultReferee);
    // Calculate strengths
    ...
    if (homePS) {
        homeStrength.attack *= 1 + (homePS.shotFrequencyBonus + homePS.shotAccuracyBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        homeStrength.midfield *= 1 + (homePS.passAccuracyBonus + homePS.possessionBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        homeStrength.defense *= 1 + (homePS.defenseBonus + homePS.tackleBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        homeStrength.overall = homeStrength.attack * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_ATTACK"] + homeStrength.midfield * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_MIDFIELD"] + homeStrength.defense * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_DEFENSE"] + homeStrength.gk * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_GK"];
    }
    if (awayPS) {
        awayStrength.attack *= 1 + (awayPS.shotFrequencyBonus + awayPS.shotAccuracyBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        awayStrength.midfield *= 1 + (awayPS.passAccuracyBonus + awayPS.possessionBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        awayStrength.defense *= 1 + (awayPS.defenseBonus + awayPS.tackleBonus) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].combinationWeight;
        awayStrength.overall = awayStrength.attack * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_ATTACK"] + awayStrength.midfield * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_MIDFIELD"] + awayStrength.defense * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_DEFENSE"] + awayStrength.gk * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OVERALL_WEIGHT_GK"];
    }
    // Home advantage: +10% base
    homeStrength.overall *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HOME_ADVANTAGE"].overall;
    homeStrength.attack *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HOME_ADVANTAGE"].attack;
    homeStrength.midfield *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HOME_ADVANTAGE"].midfield;
    homeStrength.defense *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HOME_ADVANTAGE"].defense;
    const homeTeam = {
        ...
        substitutionSlots: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].substitutionSlots,
        usedSubs: 0,
    ...
    const getByPosition = (team, pos)=>{
        ...
        candidates.sort((a, b)=>{
            const effA = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionEffectiveness"])(a.player, a.player.specificPosition || a.player.position);
            const effB = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$positionEffectiveness$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionEffectiveness"])(b.player, b.player.specificPosition || b.player.position);
            return effB - effA;
        });
        return candidates;
    };
    ...
    const determineMomentum = (minute)=>{
        ...
        if (minute <= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].earlyHomeCutoff) homeBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].earlyHomeBias;
        // Second half away team sometimes rallies
        if (minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].awayRallyStart && minute <= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].awayRallyEnd) awayBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].awayRallyBias;
        // Late game: leading team may sit back
        if (minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].leadSitBackCutoff) {
            if (homeScore > awayScore) homeBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].leadSitBack;
            if (awayScore > homeScore) awayBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].leadSitBack;
        }
        // If a team is down, they push forward
        if (homeScore < awayScore && minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].losingPushCutoff) homeBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].losingTeamPush;
        if (awayScore < homeScore && minute > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].losingPushCutoff) awayBias = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].losingTeamPush;
        // Red card penalty
        const homeReds = homeLiveStats.redCards;
        const awayReds = awayLiveStats.redCards;
        if (homeReds > 0) homeBias *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].redCardPenalty;
        if (awayReds > 0) awayBias *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOMENTUM_BIASES"].redCardPenalty;
    ...
    const performSubstitution = (team, minute, events, liveStats)=>{
        ...
        const tiredPlayers = active.filter((p)=>p.currentCond < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].tiredPlayerCondThreshold && !p.isSubbedOut && p.minuteEntered < minute).sort((a, b)=>a.currentCond - b.currentCond);
    ...
    while(currentMinute <= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].duration){
        ...
        const passCount = randInt(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PASS_SIMULATION"].minPasses, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PASS_SIMULATION"].maxPasses);
        ...
        for(let i = 0; i < passCount; i++){
            ...
            if (attackingPS?.longBallBonus && attackingPS.longBallBonus > 0) {
                passSkill *= 1 - attackingPS.longBallBonus * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PASS_SIMULATION"].longBallShortPassPenalty; // slight penalty for short passes
            }
            passer.passes++;
            ...
            if (Math.random() < passSkill) {
                ...
                // Chance for key pass
                if (Math.random() < passSkill * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PASS_SIMULATION"].keyPassChance) {
                    passer.keyPasses++;
                }
            }
        }
        ...
        if (momentumShiftCounter >= randInt(1, 3)) {
            ...
            const posWeights = [
                ...
                {
                    pos: 'DEF',
                    weight: attackingTeam.defenseStrength * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].defenseWeight
                }
            ];
            ...
            const baseGoalChance = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].base; // 3% base goal per attacking minute
            ...
            let goalChance = baseGoalChance * strengthRatio * (finishing / (finishing + gkRating * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].gkWeight));
            ...
            if (attackingTeam.overallStrength > defendingTeam.overallStrength) {
                goalChance *= 1 + qualityGap * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].qualityGapBonus;
            } else {
                goalChance *= 1 - qualityGap * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].qualityGapPenalty;
            }
            // Tactic mentality modifier
            const tacticMentalityMod = attackingTeam.tactic.mentality >= 4 ? 1 + (attackingTeam.tactic.mentality - 3) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].mentalityBonus : attackingTeam.tactic.mentality <= 2 ? 1 - (3 - attackingTeam.tactic.mentality) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].mentalityPenalty : 1.0;
            ...
            if (attackingPS?.counterBonus && attackingPS.counterBonus > 0) {
                ...
                const counterChance = Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].counterTriggerProb ? attackingPS.counterBonus : 0;
            ...
            if (attackingPS?.pressingBonus && attackingPS.pressingBonus > 0) {
                ...
                goalChance *= 1 + attackingPS.pressingBonus * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].pressingGoalBoost;
            }
            ...
            if (minute > 80) {
                if (hasMomentum === 'home' && homeScore < awayScore) goalChance *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].lateGameDesperation;
                if (hasMomentum === 'away' && awayScore < homeScore) goalChance *= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].lateGameDesperation;
            }
                ...
                if (teamIsLosing) {
                    ...
                    if (isPanicky) {
                        ...
                        if (foulRoll < 0.08 && opponentDefender) {
                            const foulEvent = createEvent(minute, 'foul', defendingTeam, opponentDefender, selectedPlayer, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].foulCommitted);
            ...
            goalChance = clamp(goalChance, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].clampMin, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_CHANCE"].clampMax);
            ...
            const assister = assistCandidates.length > 0 && Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ASSIST_CHANCE"] ? pick(assistCandidates) : undefined;
            if (shotRoll < goalChance) {
                // ── GOAL ──────────────────────────────────────────────────────
                selectedPlayer.goals++;
                selectedPlayer.shots++;
                selectedPlayer.shotsOnTarget++;
                selectedPlayer.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].goal;
                if (hasMomentum === 'home') {
                    homeScore++;
                    homeLiveStats.shots++;
                ...
                if (assister) {
                    assister.assists++;
                    assister.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].assist;
                    assister.keyPasses++;
                }
                // Determine goal type
                let goalDetail = 'normal';
                if (!assister) goalDetail = 'solo';
                if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_TYPE"].headerChance && selectedPlayer.player.specificPosition === 'ST') goalDetail = 'header';
                if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_TYPE"].longShotChance && getAttr(selectedPlayer.player, 'longShots', 50) > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_TYPE"].longShotThreshold) goalDetail = 'longShot';
                if (minute >= __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GOAL_TYPE"].lateGoalMinute) goalDetail = 'lateGoal';
                const goalEvent = createEvent(minute, 'goal', attackingTeam, selectedPlayer, assister, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].goal);
                ...
                const varResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkVARForGoal"])(refCtx, isScorerHome);
                if (varResult.varReview && varResult.overturned) {
                    ...
                    const overturnedEvent = {
                        ...
                        x: 50,
                        y: 50,
                        ratingImpact: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].redCard
                    };
                ...
                selectedPlayer.shots++;
                selectedPlayer.shotsOnTarget++;
                selectedPlayer.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotSaved;
                if (hasMomentum === 'home') {
                    homeLiveStats.shots++;
                    homeLiveStats.shotsOnTarget++;
                } else {
                ...
                if (opponentGK) {
                    opponentGK.saves++;
                    opponentGK.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].gkSave;
                    if (hasMomentum === 'home') awayLiveStats.saves++;
                    else homeLiveStats.saves++;
                    const saveEvent = createEvent(minute, 'shot_saved', attackingTeam, selectedPlayer, opponentGK, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotSaved);
                ...
                // ── Shot wide ────────────────────────────────────────────────
                selectedPlayer.shots++;
                selectedPlayer.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotWide;
                if (hasMomentum === 'home') homeLiveStats.shots++;
                else awayLiveStats.shots++;
                const wideEvent = createEvent(minute, 'shot_wide', attackingTeam, selectedPlayer, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotWide);
                ...
                selectedPlayer.shots++;
                selectedPlayer.shotsOnTarget++;
                selectedPlayer.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotPost;
                if (hasMomentum === 'home') {
                    homeLiveStats.shots++;
                    homeLiveStats.shotsOnTarget++;
                } else {
                ...
                const postEvent = createEvent(minute, 'shot_post', attackingTeam, selectedPlayer, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].shotPost);
                allEvents.push(postEvent);
                selectedPlayer.events.push(postEvent);
            } else if (shotRoll < goalChance + probs.shot * 3.5 + probs.chance) {
                // ── Chance created ───────────────────────────────────────────
                selectedPlayer.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].chanceCreated;
                if (assister) {
                    assister.keyPasses++;
                    assister.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].assistOnChance;
                }
                const chanceEvent = createEvent(minute, 'chance', attackingTeam, selectedPlayer, assister, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].chanceCreated);
                ...
                if (activeDefenders.length > 0) {
                    ...
                    if (defendingPS?.pressingBonus) {
                        tackleProb *= 1 + defendingPS.pressingBonus * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYSTYLE_WEIGHTS"].pressingTackleBoost;
                    }
                    if (Math.random() < tackleProb) {
                        defender.tackles++;
                        defender.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].tackle;
                        if (hasMomentum === 'home') awayLiveStats.tackles++;
                        else homeLiveStats.tackles++;
                        // Occasionally generate a notable tackle event
                        if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT_VISIBILITY"].tackle) {
                            const tackleEvent = createEvent(minute, 'tackle', defendingTeam, defender, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].tackle);
                    ...
                    if (Math.random() < interceptionProb) {
                        ...
                        defender.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].interception;
                        if (hasMomentum === 'home') awayLiveStats.interceptions++;
                        else homeLiveStats.interceptions++;
                        if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT_VISIBILITY"].interception) {
                            const intEvent = createEvent(minute, 'interception', defendingTeam, defender, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].interception);
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldCallFoul"])(refCtx, baseFoulProb, isDefenderHome)) {
                        defender.fouls++;
                        defender.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].foulCommitted;
                        if (hasMomentum === 'home') awayLiveStats.fouls++;
                        else homeLiveStats.fouls++;
                        // Yellow card — referee decision function
                        const baseYellowProb = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_RATES"].yellow;
                        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldGiveYellowCard"])(refCtx, baseYellowProb, isDefenderHome, minute)) {
                            defender.yellowCards++;
                            refCtx.yellowsGiven++;
                            defender.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].yellowCard;
                            if (hasMomentum === 'home') awayLiveStats.yellowCards++;
                            else homeLiveStats.yellowCards++;
                            const yellowEvent = createEvent(minute, 'yellow_card', defendingTeam, defender, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].yellowCard);
                            allEvents.push(yellowEvent);
                            defender.events.push(yellowEvent);
                        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldGiveRedCard"])(refCtx, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_RATES"].red, isDefenderHome)) {
                            // Red card — referee decision function
                            defender.redCards++;
                            refCtx.redsGiven++;
                            defender.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].redCard;
                            defender.isSubbedOut = true;
                            defender.minuteLeft = minute;
                            if (hasMomentum === 'home') awayLiveStats.redCards++;
                            else homeLiveStats.redCards++;
                            const redEvent = createEvent(minute, 'red_card', defendingTeam, defender, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].redCard);
                            allEvents.push(redEvent);
                            defender.events.push(redEvent);
                        } else {
                            // Regular foul event (sometimes visible)
                            if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_RATES"].foulVisibility * refCtx.personalityConfig.foulMultiplier * refCtx.runtimeFoulMod) {
                                const foulEvent = createEvent(minute, 'foul', defendingTeam, defender, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].foulCommitted);
                                allEvents.push(foulEvent);
                                ...
                                const penaltyResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldGivePenalty"])(refCtx, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CARD_RATES"].penalty, isAttackerHome, minute);
                                if (penaltyResult.penalty && !penaltyResult.overturned) {
                                    const penaltyEvent = createEvent(minute, 'penalty', attackingTeam, selectedPlayer, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].penalty);
                                    ...
                                    const fkEvent = createEvent(minute, 'free_kick', attackingTeam, selectedPlayer, defender, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].freeKick);
                ...
                const offsideMod = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$referee$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOffsideMultiplier"])(refCtx, isAttHome);
                if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SET_PIECE_RATES"].offside * offsideMod) {
                    const forwards = getByPosition(attackingTeam, 'FWD');
                    if (forwards.length > 0) {
                        const offsidePlayer = pick(forwards);
                        const offsideEvent = createEvent(minute, 'offside', attackingTeam, offsidePlayer, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].offside);
                ...
                // Corner
                let cornerProb = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SET_PIECE_RATES"].corner;
                ...
                if (Math.random() < cornerProb) {
                    ...
                    const cornerEvent = createEvent(minute, 'corner', attackingTeam, cornerPlayer, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].corner);
                ...
                // GK save (reactionary)
                if (opponentGK && Math.random() < probs.save * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT_VISIBILITY"].gkSaveScaling) {
                    opponentGK.saves++;
                    opponentGK.ratingDelta += __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].gkReactionarySave;
                    if (hasMomentum === 'home') awayLiveStats.saves++;
                    else homeLiveStats.saves++;
                    if (Math.random() < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENT_VISIBILITY"].gkSave) {
                        const saveEvent = createEvent(minute, 'save', defendingTeam, opponentGK, undefined, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RATING_IMPACT"].gkReactionarySave);
                        allEvents.push(saveEvent);
                        opponentGK.events.push(saveEvent);
                    }
                }
            ...
            for (const p of activeForInjury){
                ...
                const injuryRisk = p.currentCond < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].condThresholdLow ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].low : p.currentCond < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].condThresholdMid ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].mid : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].base;
                if (Math.random() < injuryRisk) {
                    const { severity, days } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$injuryManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateInjury"])();
                    p.isInjured = true;
                    p.minuteLeft = minute;
                    p.ratingDelta += severity === 'heavy' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].ratingImpactHeavy : severity === 'medium' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].ratingImpactMedium : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INJURY_RISK"].ratingImpactLight;
        ...
        for (const p of getActivePlayers(homeTeam)){
            let drain = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONDITION_DRAIN"].base + (p.player.stamina ? (100 - getAttr(p.player, 'stamina', 50)) / __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONDITION_DRAIN"].staminaDivisor : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONDITION_DRAIN"].fallbackDrain);
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].autoSubMinutes.includes(minute)) {
            performSubstitution(homeTeam, minute, allEvents, homeLiveStats);
            performSubstitution(awayTeam, minute, allEvents, awayLiveStats);
        }
        // ── Halftime ────────────────────────────────────────────────────────
        if (minute === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].halftime) {
            allEvents.push({
                minute: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].halftime,
                type: 'chance',
                team: 'home',
                playerName: '',
                playerId: '',
    ...
    // ── Fulltime ────────────────────────────────────────────────────────────
    allEvents.push({
        minute: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MATCH_STRUCTURE"].duration,
        type: 'chance',
        team: 'home',
        playerName: '',
        playerId: '',
    ...
    const calculatePlayerRating = (state)=>{
        // Base rating
        let rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].baseRating;
        // Position-adjusted base
        const pos = positionGroup(state.player);
        switch(pos){
            case 'GK':
                rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].baseRating;
                rating += state.saves * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].GK.perSave;
                rating -= state.goals > 0 ? state.goals * -__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].GK.perGoalConceded : 0;
                break;
            case 'DEF':
                rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].baseRating;
                rating += state.tackles * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].DEF.perTackle;
                rating += state.interceptions * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].DEF.perInterception;
                rating += state.assists * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].DEF.perAssist;
                rating += state.goals * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].DEF.perGoal;
                break;
            case 'MID':
                rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].baseRating;
                rating += state.keyPasses * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].MID.perKeyPass;
                rating += state.passes * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].MID.perPass;
                rating += state.tackles * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].MID.perTackle;
                rating += state.goals * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].MID.perGoal;
                rating += state.assists * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].MID.perAssist;
                break;
            case 'FWD':
                rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].baseRating;
                rating += state.goals * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].FWD.perGoal;
                rating += state.assists * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].FWD.perAssist;
                rating += state.shotsOnTarget * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].FWD.perShotOnTarget;
                rating += (state.shots - state.shotsOnTarget) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].FWD.perMissedShot;
                break;
        }
        // Card penalties
        rating += state.yellowCards * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].yellowCardPenalty;
        rating += state.redCards * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].redCardPenalty;
        // Fouls penalty
        rating += state.fouls * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].foulPenalty;
        ...
        const ptf = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].playingTimeFactors;
        const playingTimeFactor = minutesPlayed >= 85 ? ptf.full85 : minutesPlayed >= 60 ? ptf.mid60 : minutesPlayed >= 30 ? ptf.low30 : ptf.sub30;
        rating = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].ratingShiftBase + (rating - __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].ratingShiftBase) * playingTimeFactor;
        // Morale, form, condition modifiers (subtle)
        const avgMental = (state.player.morale + state.player.form + state.player.confidence) / 300;
        rating += (avgMental - 0.5) * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].mentalModifierStrength;
        rating = clamp(Math.round(rating * 10) / 10, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].ratingClamp.min, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAYER_RATING_WEIGHTS"].ratingClamp.max);
        return {
...
function applyRoleBonuses(players, playerRoles) {
    ...
    return players.map((p)=>{
        ...
        if (!roleId) return p;
        const bonuses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$tacticsRoles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRoleAttributeBonuses"])(roleId);
...
async function runUnifiedMatch(homeSquad, awaySquad, options) {
    ...
    const homePSMods = options.homePlayStyleModifiers ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playStyles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTeamPlayStyleModifiers"])(effectiveHomeSquad, homeTactic.playStyle);
    const awayPSMods = options.awayPlayStyleModifiers ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playStyles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateTeamPlayStyleModifiers"])(awaySquad, awayTactic.playStyle);
    ...
    if (!simulationOptions.weather && options.matchDate) {
        try {
            const { getWeatherForDate } = await __turbopack_context__.A("[project]/src/lib/fm/stadiumMatrix.ts [app-client] (ecmascript, async loader)");
    ...
    if (Object.keys(upgrades).length > 0) {
        if (options.isNightMatch === undefined || options.isWinterMatch === undefined) {
            try {
                const { detectMatchConditions } = await __turbopack_context__.A("[project]/src/lib/fm/stadiumMatrix.ts [app-client] (ecmascript, async loader)");
    ...
    if (pitchLevel > 0) simulationOptions.pitchPassBonus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPitchPassAccuracyBonus"])(pitchLevel);
    const heatingLevel = upgrades['heating'] || 0;
    if (heatingLevel > 0 && options.isWinterMatch) simulationOptions.heatingProtection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHeatingWinterProtection"])(heatingLevel);
    const lightingLevel = upgrades['lighting'] || 0;
    if (lightingLevel > 0 && options.isNightMatch) simulationOptions.lightingNightBonus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLightingNightBonus"])(lightingLevel);
    ...
    if (options.stadiumEffects) {
        const { modifiedHomeSquad, modifiedAwaySquad } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyStadiumEffects"])(effectiveHomeSquad, awaySquad, options.stadiumEffects);
    ...
    if (options.stadiumUpgrades && Object.keys(options.stadiumUpgrades).length > 0) {
        const effects = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeStadiumEffects"])(options.stadiumUpgrades, options.isNightMatch, options.isWinterMatch);
        const { modifiedHomeSquad, modifiedAwaySquad } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyStadiumEffects"])(effectiveHomeSquad, awaySquad, effects);
        const enhancedResult = simulateEnhancedMatch(modifiedHomeSquad, modifiedAwaySquad, homeTactic, awayTactic, simulationOptions);
        return convertEnhancedToLegacy(enhancedResult, homeSquad, options);
    }
...
"[project]/src/lib/fm/traits.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$traitsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TRAITS_DATA"]).forEach((posData)=>{
    if (posData?.pozitif) {
...
Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$traitsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PERSONALITY_TRAITS"]).forEach(([cat, data])=>{
    if (cat === 'nadir') {
        data.forEach((t)=>{
            traitDescriptions[t.name] = {
                name: t.name,
...
const getPlayStyleInfo = (styleName)=>{
    for (const pos of Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$traitsData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PLAY_STYLES"])){
...
"[project]/src/lib/fm/careerStats.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/evolution.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var _c;
__turbopack_context__.k.register(_c, "UpdatePlayerStats");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/fm/retirement.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function processSeasonEndRetirements(squad, teamId) {
    ...
    for (const player of squad){
        if (shouldPlayerRetire(player)) {
            ...
            const pos = player.position || 'MID';
            const talent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playerGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateStarterPlayer"])(pos);
...
"[project]/src/lib/fm/youthAcademy.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateYouthStats(specificPosition, baseRating, rngFn = Math.random) {
    ...
    const posKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPositionKey"])(specificPosition);
    ...
    if (priorities) {
        ...
        for (const [trKey, priority] of Object.entries(priorities.teknik)){
            ...
            if (engKey) {
                const val = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAttributeValue"])(priority);
        ...
        // Goalkeeping
        if (posKey === 'GK') {
            stats.goalkeeping = clamp(Math.round((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAttributeValue"])('cok_yuksek') * (baseRating / 65)), 10, 85);
        } else {
            stats.goalkeeping = clamp(Math.round((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAttributeValue"])('cok_dusuk') * (baseRating / 65)), 5, 35);
        }
        // offTheBall
        if (!stats.offTheBall) {
            stats.offTheBall = posKey === 'FWD' ? clamp(Math.round((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAttributeValue"])('yuksek') * (baseRating / 65)), 5, 85) : clamp(Math.round((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$attributeGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateAttributeValue"])('orta') * (baseRating / 65)), 5, 85);
        }
    } else {
...
"[project]/src/lib/fm/seasonAwardsService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function saveSeasonAwardsAndSummary(awards, summary, badge, profileId) {
    try {
        ...
        if (badge) {
            ...
            const existingBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$sharedUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeJsonParse"])(profileData.season_badges, []);
    ...
    try {
        ...
        if (supabase) {
            ...
            if (data?.season_badges) {
                const badges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$sharedUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeJsonParse"])(data.season_badges, []);
...
function mapAwardFromRow(row) {
    return {
        ...
        stat_detail: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$sharedUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeJsonParse"])(row.stat_detail, undefined),
...
"[project]/src/lib/fm/operations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/DefenseManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/OperationManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$operations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/operations.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$DefenseManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/DefenseManager.ts [app-client] (ecmascript)");
;
;
class OperationManager {
    ...
    launchOperation(opId, state, budget) {
        const op = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$operations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATIONS"].find((o)=>o.id === opId);
        if (!op) return {
            state,
            cost: 0,
    ...
    resolveOperations(state, targetProfile) {
        ...
        const resolvedOps = activeOps.map((active)=>{
            ...
            const op = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$operations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATIONS"].find((o)=>o.id === active.operationId);
            if (!op) return {
                ...active,
                status: 'completed'
            };
            ...
            if (targetProfile && op.category) {
                successChance = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$DefenseManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DefenseManager"].calculateSuccessChance(op.successRate, op.category, targetProfile);
                scandalRisk = op.scandalRisk * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$DefenseManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DefenseManager"].getScandalReboundMultiplier(targetProfile, op.category);
            }
            const roll = Math.random();
   ...
   */ simulateEnemyAttack(userProfile, state) {
        ...
        const finalSuccess = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$DefenseManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DefenseManager"].calculateSuccessChance(baseEnemySuccess, category, userProfile);
...
"[project]/src/lib/fm/evolutionDayService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$evolution$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/evolution.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$retirement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/retirement.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playerGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/playerGenerator.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$seasonAwardsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/seasonAwardsService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$OperationManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/OperationManager.ts [app-client] (ecmascript)");
;
;
;
;
...
function processEvolutionDay(input) {
    ...
    let updatedSquad = squad.map((player)=>{
        ...
        let evolved = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$evolution$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UpdatePlayerStats"])(player, performance);
        if (profile.current_day % 34 === 17 && !evolved.is_retiring) {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$retirement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldPlayerRetire"])(evolved)) evolved.is_retiring = true;
        }
        return evolved;
    });
    // Apply daily updates (injuries, form, morale)
    updatedSquad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$evolution$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processDailyUpdates"])(updatedSquad);
    ...
    if (isSeasonEnd) {
        const { updatedSquad: nextSeasonSquad, retiredPlayers, newTalents } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$retirement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processSeasonEndRetirements"])(updatedSquad, profile.id);
        updatedSquad = nextSeasonSquad;
        // Stadium Academy Bonus
        const academyLvl = (profile.stadium_upgrades || {})['academy'] || 0;
        if (academyLvl === 10) {
            const eliteWonderkid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playerGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateEliteWonderkid"])();
        ...
        for(let i = 0; i < intakeCount; i++){
            const yp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$youthAcademy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateYouthPlayer"])(academyLevel);
            const withReport = {
                ...yp,
                scoutReport: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$youthAcademy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateScoutReport"])(yp)
            };
        ...
        if (retiredPlayers.length > 0 && profile.id) {
            const retiredSeason = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$seasonAwardsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSeasonId"])(profile.current_day);
            hofInduction = {
                retiredPlayers,
    ...
    if (currentDay > 0 && currentDay % 7 === 0) {
        if (updatedYouthPlayers.length > 0) {
            const facilityStates = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$youthAcademy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YOUTH_FACILITIES"].map((f)=>({
                    facilityId: f.id,
                    currentLevel: youthFacilities[f.id] ?? 1
                }));
            updatedYouthPlayers = updatedYouthPlayers.map((yp)=>{
                try {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$youthAcademy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processYouthWeeklyTraining"])(yp, facilityStates);
                } catch  {
                    return yp;
                }
            });
            ...
            if (s.status === 'SCOUTING') {
                ...
                if (remaining <= 0) {
                    ...
                    for(let i = 0; i < playerCount; i++){
                        ...
                        const p = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playerGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateStarterPlayer"])(pos);
    ...
    let alertInfo = null;
    if (Math.random() < 0.1) {
        const { updatedState, alertHeader, alertText } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$OperationManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OperationManager"].getInstance().simulateEnemyAttack(updatedProfile, updatedTrainingState);
...
"[project]/src/lib/fm/helpers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/emotionalEvents.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function emitEmotionalEvent(event) {
    try {
        ...
        try {
            if (event.type === 'CHAMPION') (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('champion');
            else if (event.type === 'PROMOTION') (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('applause');
            else if (event.type === 'BIG_TRANSFER') (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('transfer');
            else if (event.type.startsWith('RECORD_')) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('record');
        } catch  {}
    } catch (err) {
...
"[project]/src/lib/fm/schedule.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/league.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/supabaseRateLimit.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/security.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$supabaseRateLimit$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/supabaseRateLimit.ts [app-client] (ecmascript)");
...
if (typeof setInterval !== 'undefined') {
    setInterval(()=>{
        ...
        __turbopack_context__.A("[project]/src/lib/fm/supabaseRateLimit.ts [app-client] (ecmascript, async loader)").then(({ cleanupRateLimits })=>cleanupRateLimits());
    }, 5 * 60 * 1000);
}
...
"[project]/src/lib/fm/unifiedMessagingService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/fm/security.ts [app-client] (ecmascript) <locals>");
;
;
...
async function sendDirectMessage(conversationId, senderId, content, messageType = 'general') {
    try {
        ...
        const trimmed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sanitizeInput"])(content, 500);
        if (!trimmed) return {
            error: 'Mesaj boş olamaz'
        };
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isValidMessageType"])(messageType)) {
            return {
...
async function searchRivalManagers(myId, query, limit = 10) {
    try {
        ...
        const safeQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sanitizeLikePattern"])(query);
...
async function sendMatchChatMessage(fixtureId, profileId, senderName, content) {
    try {
        ...
        const trimmed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$security$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["sanitizeInput"])(content, 200);
        if (!trimmed) return {
            success: false,
            error: 'Empty message'
        };
...
"[project]/src/lib/fm/financialModel.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function calculateWeeklyRevenue(profile, lastMatchAttendance, isHome, leaguePosition, tier = 1) {
    ...
    if (isHomeMatch) {
        ...
        const ticketMultiplier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStadiumTicketRevenueMultiplier"])(stadiumLevel);
        ...
        const vipRevenue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getVIPRevenuePerMatch"])(vipLevel);
    ...
    const mediaMultiplier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMediaSponsorMultiplier"])(mediaLevel);
    ...
    const storeDailyRevenue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoreDailyRevenue"])(storeLevel);
...
"[project]/src/lib/fm/InfoContentManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/mediaSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/hallOfFameService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function mapHofFromRow(row) {
    return {
        ...
        awards_won: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$sharedUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeJsonParse"])(row.awards_won, []),
...
"[project]/src/lib/fm/multiplayer.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const initFreeAgentsOnMarket = async ()=>{
    ...
    for(let i = 0; i < needed; i++){
        ...
        const p = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$playerGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generatePlayer"])(pos);
        players.push({
            player_id: p.id,
            player_data: p,
...
"[project]/src/lib/fm/playerDemands.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generatePlayerDemands(rating, isFreeAgent) {
    const salary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$salaryUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateSalaryRange"])(rating, isFreeAgent);
    const fee = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$salaryUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateSigningFeeRange"])(rating);
    return {
...
"[project]/src/lib/fm/migration.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function migrateLocalStorageToSupabase(userId) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])() || !userId) return {
        success: false,
        count: 0
    };
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabase"])();
    ...
    try {
        ...
        if (localSquad) {
            ...
            count = squad.length;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["savePlayers"])(squad, userId);
        }
        return {
            success: true,
            count
...
"[project]/src/lib/fm/FitnessManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/useDbHealth.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/persistence.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/migration.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$FitnessManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/FitnessManager.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$schedule$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/fm/schedule.ts [app-client] (ecmascript)");
...
function useDbHealth(userId, squad, activeTactic, teamStats, setSquad) {
    _s();
    const [dbStatus, setDbStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('checking');
    const [dbLatency, setDbLatency] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [showMigrationBanner, setShowMigrationBanner] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const handleCheckDb = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDbHealth.useCallback[handleCheckDb]": async ()=>{
            if (dbStatus === 'not_configured') {
                alert('Supabase henüz yapılandırılmamış.');
            } else {
                const health = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkConnectionHealth"])();
                setDbStatus(health.status);
                setDbLatency(health.latency ?? null);
            }
        }
    }["useDbHealth.useCallback[handleCheckDb]"], [
        dbStatus
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDbHealth.useEffect": ()=>{
            const checkDb = {
                "useDbHealth.useEffect.checkDb": async ()=>{
                    const health = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkConnectionHealth"])();
                    setDbStatus(health.status);
                    setDbLatency(health.latency ?? null);
                    const last = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadLastMatchResult"])();
                    if (last) setLastMatch(last);
                    if (health.status === 'connected' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) {
                        if (userId) {
                            const counts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkSupabaseData"])(userId);
                            if (counts.players === 0) setShowMigrationBanner(true);
                        }
                        // Move free agents to market on startup if connected
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$multiplayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initFreeAgentsOnMarket"])();
                    }
                }
            }["useDbHealth.useEffect.checkDb"];
            checkDb();
            const interval = setInterval(checkDb, 300000);
            return ({
                "useDbHealth.useEffect": ()=>clearInterval(interval)
            })["useDbHealth.useEffect"];
        }
    }["useDbHealth.useEffect"], [
        userId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDbHealth.useEffect": ()=>{
            const interval = setInterval({
                "useDbHealth.useEffect.interval": ()=>{
                    const now = new Date();
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$schedule$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTrainingTime"])(now)) {
                        const rehabLevel = teamStats.medical || 1;
                        const intensity = activeTactic.intensity || 'normal';
                        setSquad({
                            "useDbHealth.useEffect.interval": (prev)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$FitnessManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FitnessManager"].restoreFitness(prev, rehabLevel, intensity)
                        }["useDbHealth.useEffect.interval"]);
                    }
                }
            }["useDbHealth.useEffect.interval"], 180000);
            return ({
                "useDbHealth.useEffect": ()=>clearInterval(interval)
            })["useDbHealth.useEffect"];
        }
    ...
    const handleMigrate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDbHealth.useCallback[handleMigrate]": async ()=>{
            setMigrating(true);
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["migrateLocalStorageToSupabase"])('guest-manager');
    ...
    }["useDbHealth.useCallback[handleMigrate]"], []);
    return {
        dbStatus,
        dbLatency,
        migrating,
...
_s(useDbHealth, "n8g6/bD6pOq4GMZaBSXaBtA9/nU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/fm/useYouthAcademy.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useYouthAcademy(profileId) {
    _s();
    const [youthPlayers, setYouthPlayers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [youthFacilities, setYouthFacilities] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    // Track whether initial load has completed to avoid saving empty state
    const youthFacilitiesLoadedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // Load youth players + facilities on profile load
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useYouthAcademy.useEffect": ()=>{
            if (!profileId) return;
            let cancelled = false;
            ({
                "useYouthAcademy.useEffect": async ()=>{
                    try {
                        const [loadedPlayers, loadedFacilities] = await Promise.all([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadYouthPlayers"])(profileId),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadYouthFacilities"])(profileId)
                        ]);
                        if (!cancelled) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useYouthAcademy.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$persistence$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveYouthFacilities"])(youthFacilities, profileId);
        }
    }["useYouthAcademy.useEffect"], [
        youthFacilities,
        profileId
...
_s(useYouthAcademy, "M2p/UCxPa0DtimQR0RlpP2VmzPY=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/fm/useCupSeasons.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCupSeasons(profileId, teamName) {
    _s();
    const [cupSeasons, setCupSeasons] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCupSeasons.useEffect": ()=>{
            if (!profileId || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupabaseConfigured"])()) return;
            fetch(`/api/cups/my-seasons?profileId=${profileId}&teamName=${encodeURIComponent(teamName || '')}`).then({
                "useCupSeasons.useEffect": (r)=>r.json()
            }["useCupSeasons.useEffect"]).then({
                "useCupSeasons.useEffect": (data)=>{
                    if (Array.isArray(data)) setCupSeasons(data);
                }
            }["useCupSeasons.useEffect"]).catch({
                "useCupSeasons.useEffect": ()=>{}
            }["useCupSeasons.useEffect"]);
        }
    }["useCupSeasons.useEffect"], [
...
_s(useCupSeasons, "hsR2dypokEJAa35QhF4UFtgyMCc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/lib/fm/useActiveOperations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useActiveOperations(userId, activeTab) {
    _s();
    const [activeOperations, setActiveOperations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useActiveOperations.useEffect": ()=>{
            if (userId) {
                __turbopack_context__.A("[project]/src/lib/fm/persistence.ts [app-client] (ecmascript, async loader)").then({
                    "useActiveOperations.useEffect": ({ getMatchPreparations })=>{
                        getMatchPreparations(userId).then({
                            "useActiveOperations.useEffect": (preps)=>{
...
_s(useActiveOperations, "rhp08GEvjmgmxGD3zmjN8aJyyzg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
// ═══════════════════════════════════════════════════════════════
const VAPID_PUBLIC_KEY = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VAPID_PUBLIC_KEY || '';
/**
...
function getVapidPublicKey() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_VAPID_PUBLIC_KEY || '';
}
function getVapidPrivateKey() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.VAPID_PRIVATE_KEY || '';
}
...
async function sendPushToProfile(profileId, payload) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        console.warn('[push] sendPushToProfile only works server-side');
        return 0;
    }
...
"[project]/src/lib/fm/youthAcademySeasonSync.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function generateYouthPlayersForAllTeams(supabase) {
    ...
    for (const team of uniqueProfiles){
        ...
        for(let i = 0; i < youthCount; i++){
            const youthPlayer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$youthAcademy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateYouthPlayer"])(academyLevel);
            // Apply academy quality multiplier from stadiumMatrix
            const academyQualityMultiplier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$stadiumMatrix$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAcademyQualityMultiplier"])(academyLevel);
...
"[project]/src/lib/fm/cupSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/fm/useEmotionalEvents.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useEmotionalEvents() {
    _s();
    const { matchState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$fm$2f$MatchContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMatchContext"])();
    // Gol kutlama state
    const [goalCelebrationTrigger, setGoalCelebrationTrigger] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [goalScorer, setGoalScorer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [goalMinute, setGoalMinute] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    // Maç olaylarını dinle ve gol kutlamasını tetikle
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useEmotionalEvents.useEffect": ()=>{
            ...
            if (lastEvent?.type === 'GOAL' && lastEvent.team === 'HOME') {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$sound$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('goal');
                setTimeout({
                    "useEmotionalEvents.useEffect": ()=>setGoalCelebrationTrigger(false)
                }["useEmotionalEvents.useEffect"], 2600);
            }
        }
    }["useEmotionalEvents.useEffect"], [
...
_s(useEmotionalEvents, "xJOY3iWevJuEsJmk/iyycHraW98=", false, function() {
    return [
...
"[project]/src/lib/fm/useOnboarding.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$OnboardingTutorial$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/OnboardingTutorial.tsx [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
function useOnboarding(profileId) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useOnboarding.useEffect": ()=>{
            if (profileId) {
                void (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$OnboardingTutorial$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldShowOnboarding"])(profileId).then(setShowOnboarding);
            }
        }
    }["useOnboarding.useEffect"], [
        profileId
...
_s(useOnboarding, "fpS8WRWsB7s+ZIHM1Tv5RfwfY0k=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_lib_956cc3ef._.js.map